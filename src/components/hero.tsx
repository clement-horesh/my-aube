...
function HeroText() {
  return (
    <div className="flex flex-col gap-4 text-center sm:text-left relative z-20">
      ...
      Mettez en <span className="bg-gradient-to-r from-pink-300 via-orange-300 to-yellow-300 bg-clip-text text-transparent drop-shadow-[0_0_8px_rgba(251,146,60,0.3)] dark:drop-shadow-[0_0_10px_rgba(251,146,60,0.4)] animate-[pulse_2s_ease_forwards]">lumière</span> <br/> vos performances.
